...
const SliderCard = ({ data }) => {
  ...
  return (
    <div className="card-big flex w-60 cursor-pointer flex-col gap-1 sm:h-[420px]">
      ...
      <div className="info-box h-1/3 w-full bg-eGray p-2">
